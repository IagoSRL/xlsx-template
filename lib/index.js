...
var path = require('path'), sizeOf = require('image-size').imageSize, fs = require('fs'), etree = require('elementtree'), zip = require("@kant2002/jszip");
...
var Workbook = /** @class */ (function () {
     ...
     */
    Workbook.prototype.copySheet = function (sheetName, copyName, binary) {
        ...
        self.workbook.findall('definedNames/definedName').forEach(function (element) {
    ...
    Workbook.prototype.substitute = function (sheetName, substitutions) {
        ...
        sheetData.findall("row").forEach(function (row) {
                ...
                if (cell.attrib.t === "s") {
                    ...
                    self.extractPlaceholders(string).forEach(function (placeholder) {
                        ...
                        if (placeholder.full && placeholder.type === "table" && substitution instanceof Array) {
                            ...
                            newCellsInserted = self.substituteTable(row, newTableRows, cells, cell, namedTables, substitution, placeholder.key, placeholder, drawing);
            ...
            if (newTableRows.length > 0) {
                ...
                var cellsOverTable = row.findall("c").filter(function (cell) { return !cellsForsubstituteTable.includes(cell); });
    ...
    Workbook.prototype.substituteHyperlinks = function (rels, substitutions) {
        ...
        var relationships = rels.root._children;
        relationships.forEach(function (relationship) {
            if (relationship.attrib.Type === HYPERLINK_RELATIONSHIP) {
                var target_1 = relationship.attrib.Target;
                //Double-decode due to excel double encoding url placeholders
                target_1 = decodeURI(decodeURI(target_1));
                self.extractPlaceholders(target_1).forEach(function (placeholder) {
                    var substitution = substitutions[placeholder.name];
                    if (substitution === undefined) {
                        return;
                    }
                    target_1 = target_1.replace(placeholder.placeholder, self.stringify(substitution));
                    relationship.attrib.Target = encodeURI(target_1);
                });
            }
        });
    };
        ...
        if (substitution.length === 0) {
            ...
            substitution.forEach(function (element, idx) {
                ...
                if (idx === 0) { // insert in the row where the placeholders are
                    ...
                    var mergeCell = self.sheet.root.findall("mergeCells/mergeCell")
                        .find(function (c) { return self.splitRange(c.attrib.ref).start === cell.attrib.r; });
                    var isMergeCell = mergeCell != null;
                    if (isMergeCell) {
                        var originalMergeRange = self.splitRange(mergeCell.attrib.ref), originalMergeStart_1 = self.splitRef(originalMergeRange.start), originalMergeEnd = self.splitRef(originalMergeRange.end);
                        var _loop_1 = function (colnum) {
                            var originalRow = self.sheet.root.find('sheetData')._children.find(function (f) { return f.attrib.r == originalMergeStart_1.row; });
                            var col = self.numToChar(colnum);
                            var originalCell = originalRow._children.find(function (f) { return f.attrib.r.startsWith(col); });
                            var addtionalCell = self.cloneElement(originalCell);
                        ...
                        for (var colnum = self.charToNum(originalMergeStart_1.col) + 1; colnum <= self.charToNum(originalMergeEnd.col); colnum++) {
                            _loop_1(colnum);
                        }
                    }
     ...
     */
    Workbook.prototype.initRichData = function () {
        if (!this.richDataIsInit) {
            var _relsrichValueRel = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n        <Relationships xmlns=\"http://schemas.openxmlformats.org/package/2006/relationships\">\n        </Relationships>";
            var rdrichvalue = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n        <rvData xmlns=\"http://schemas.microsoft.com/office/spreadsheetml/2017/richdata\" count=\"0\">\n        </rvData>";
            var rdrichvaluestructure = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n            <rvStructures xmlns=\"http://schemas.microsoft.com/office/spreadsheetml/2017/richdata\" count=\"1\">\n                <s t=\"_localImage\">\n                    <k n=\"_rvRel:LocalImageIdentifier\" t=\"i\"/>\n                    <k n=\"CalcOrigin\" t=\"i\"/>\n                </s>\n            </rvStructures>";
            var rdRichValueTypes = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n        <rvTypesInfo xmlns=\"http://schemas.microsoft.com/office/spreadsheetml/2017/richdata2\"\n            xmlns:mc=\"http://schemas.openxmlformats.org/markup-compatibility/2006\" mc:Ignorable=\"x\"\n            xmlns:x=\"http://schemas.openxmlformats.org/spreadsheetml/2006/main\">\n            <global>\n                <keyFlags>\n                    <key name=\"_Self\">\n                        <flag name=\"ExcludeFromFile\" value=\"1\"/>\n                        <flag name=\"ExcludeFromCalcComparison\" value=\"1\"/>\n                    </key>\n                    <key name=\"_DisplayString\">\n                        <flag name=\"ExcludeFromCalcComparison\" value=\"1\"/>\n                    </key>\n                    <key name=\"_Flags\">\n                        <flag name=\"ExcludeFromCalcComparison\" value=\"1\"/>\n                    </key>\n                    <key name=\"_Format\">\n                        <flag name=\"ExcludeFromCalcComparison\" value=\"1\"/>\n                    </key>\n                    <key name=\"_SubLabel\">\n                        <flag name=\"ExcludeFromCalcComparison\" value=\"1\"/>\n                    </key>\n                    <key name=\"_Attribution\">\n                        <flag name=\"ExcludeFromCalcComparison\" value=\"1\"/>\n                    </key>\n                    <key name=\"_Icon\">\n                        <flag name=\"ExcludeFromCalcComparison\" value=\"1\"/>\n                    </key>\n                    <key name=\"_Display\">\n                        <flag name=\"ExcludeFromCalcComparison\" value=\"1\"/>\n                    </key>\n                    <key name=\"_CanonicalPropertyNames\">\n                        <flag name=\"ExcludeFromCalcComparison\" value=\"1\"/>\n                    </key>\n                    <key name=\"_ClassificationId\">\n                        <flag name=\"ExcludeFromCalcComparison\" value=\"1\"/>\n                    </key>\n                </keyFlags>\n            </global>\n        </rvTypesInfo>";
            var richValueRel = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n        <richValueRels xmlns=\"http://schemas.microsoft.com/office/spreadsheetml/2022/richvaluerel\"\n            xmlns:r=\"http://schemas.openxmlformats.org/officeDocument/2006/relationships\">\n        </richValueRels>";
            var metadata = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n        <metadata xmlns=\"http://schemas.openxmlformats.org/spreadsheetml/2006/main\"\n            xmlns:xlrd=\"http://schemas.microsoft.com/office/spreadsheetml/2017/richdata\">\n            <metadataTypes count=\"1\">\n                <metadataType name=\"XLRICHVALUE\" minSupportedVersion=\"120000\" copy=\"1\" pasteAll=\"1\" pasteValues=\"1\" merge=\"1\" splitFirst=\"1\" rowColShift=\"1\" clearFormats=\"1\" clearComments=\"1\" assign=\"1\" coerce=\"1\"/>\n            </metadataTypes>\n            <futureMetadata name=\"XLRICHVALUE\" count=\"0\">\n            </futureMetadata>\n            <valueMetadata count=\"0\">\n            </valueMetadata>\n        </metadata>";
            var _relsrichValueRelFileName = 'xl/richData/_rels/richValueRel.xml.rels';
            var rdrichvalueFileName = 'xl/richData/rdrichvalue.xml';
            var rdrichvaluestructureFileName = 'xl/richData/rdrichvaluestructure.xml';
            var rdRichValueTypesFileName = 'xl/richData/rdRichValueTypes.xml';
            var richValueRelFileName = 'xl/richData/richValueRel.xml';
            var metadataFileName = 'xl/metadata.xml';
    ...
    ;
    Workbook.prototype.writeRichDataAlreadyExist = function (element, elementSearchName, attributeName, attributeValue) {
        for (var _i = 0, _a = element.findall(elementSearchName); _i < _a.length; _i++) {
            var e = _a[_i];
     ...
     */
    Workbook.prototype.writeRichData = function () {
        if (this.richDataIsInit) {
            var _relsrichValueRelFileName = 'xl/richData/_rels/richValueRel.xml.rels';
            var rdrichvalueFileName = 'xl/richData/rdrichvalue.xml';
            var rdrichvaluestructureFileName = 'xl/richData/rdrichvaluestructure.xml';
            ...
            var wbrelsidMax = this.findMaxId(this.workbookRels, 'Relationship', 'Id', /rId(\d*)/);
    ...
    Workbook.prototype.substituteImageInCell = function (cell, substitution) {
        ...
        var maxIdRichData = this.findMaxId(this._relsrichValueRel, 'Relationship', 'Id', /rId(\d*)/);
        var _rel = etree.SubElement(this._relsrichValueRel, 'Relationship');
        ...
        var currentCountrdRichValue = this.rdrichvalue.get('count');
        this.rdrichvalue.set('count', parseInt(currentCountrdRichValue) + 1);
        var rv = etree.SubElement(this.rdrichvalue, 'rv');
        rv.set('s', "0");
        var firstV = etree.SubElement(rv, 'v');
        var secondV = etree.SubElement(rv, 'v');
        firstV.text = currentCountrdRichValue;
        secondV.text = "5";
        var rel = etree.SubElement(this.richValueRel, 'rel');
        rel.set("r:id", 'rId' + maxIdRichData);
        var futureMetadataCount = this.metadata.find('futureMetadata').get('count');
        this.metadata.find('futureMetadata').set('count', parseInt(futureMetadataCount) + 1);
        var bk = etree.SubElement(this.metadata.find('futureMetadata'), 'bk');
        var extLst = etree.SubElement(bk, 'extLst');
        var ext = etree.SubElement(extLst, 'ext');
        ext.set("uri", "{3e2802c4-a4d2-4d8b-9148-e3be6c30e623}");
        var xlrd_rvb = etree.SubElement(ext, 'xlrd:rvb');
        xlrd_rvb.set("i", futureMetadataCount);
        var valueMetadataCount = this.metadata.find('valueMetadata').get('count');
        this.metadata.find('valueMetadata').set('count', parseInt(valueMetadataCount) + 1);
        var bk_VM = etree.SubElement(this.metadata.find('valueMetadata'), 'bk');
        var rc = etree.SubElement(bk_VM, 'rc');
        rc.set("t", "1");
    ...
    Workbook.prototype.getWidthMergeCell = function (mergeCell, sheet) {
        ...
        for (var i = mergeStartCol; i < mergeEndCol + 1; i++) {
    ...
    Workbook.prototype.getHeightMergeCell = function (mergeCell, sheet) {
        ...
        for (var i = mergeStartRow; i < mergeEndRow + 1; i++) {
    ...
    Workbook.prototype.findMaxFileId = function (fileNameRegex, idRegex) {
        ...
        var maxid = files.reduce(function (p, c) {
            var num = parseInt(idRegex.exec(c.name)[1]);
            if (p == null) {
                return num;
            }
            return p > num ? p : num;
    ...
    Workbook.prototype.findMaxId = function (element, tag, attr, idRegex) {
        var maxId = 0;
        element.findall(tag).forEach(function (element) {
